...
local games_regex = "^(steam_app_.*|steam_proton|streaming_client|gamescope|wow.exe|World of Warcraft.*)$"
hl.window_rule({
    name = "force-workspace-5",
    match = {
        class = games_regex,
        title = games_regex
    },
...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("systemctl --user start ptt-fix")
end)
...
-- proton
hl.env("WAYLANDDRV_PRIMARY_MONITOR", "DP-2")
...
hl.bind(mainMod .. " + HOME", hl.dsp.submap("clean"))
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("wofi -r --show drun --allow-images -D key_expand=Tab"))
